...
| 練習の分析 | 目標の設定 | コーチのカルテ |
| --- | --- | --- |
| ![チャット画面](docs/screenshots/chat.png) | ![目標設定](docs/screenshots/goal.png) | ![カルテ画面](docs/screenshots/karte.png) |
...
| 目標 | レースペース | 閾値走 | インターバル | 週間距離の目安 |
| --- | --- | --- | --- | --- |
| サブ3 | 4:15/km | 4:04/km | 3:46/km | 週60〜80km |
| サブ3.5 | 4:58/km | 4:45/km | 4:24/km | 週50〜70km |
| サブ4 | 5:41/km | 5:25/km | 5:01/km | 週40〜55km |
| サブ5 | 7:06/km | 6:47/km | 6:17/km | 週30〜40km |
| 完走 | ペースより「止まらずに動き続けられる時間」で評価 | | | 週25〜35km |
| 健康維持 | 距離とタイムのノルマを置かない | | | — |

プリセット以外の目標タイムも自由に設定できます。
...
- 目標（サブ3 / サブ3.25 / サブ3.5 / サブ4 / サブ4.5 / サブ5 / 完走 / 健康維持、または自由入力の目標タイム）
...
126 件のテストが、痛み検知・走行指示の検査・目標からのペース導出・フェーズ判定・
