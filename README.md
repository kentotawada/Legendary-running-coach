...
| 心拍ゾーン | 練習メニュー | 目標の設定 | 相談アイデア |
| --- | --- | --- | --- |
| ![チャット画面](docs/screenshots/chat.png) | ![メニューカード](docs/screenshots/menu-card.png) | ![目標設定](docs/screenshots/goal.png) | ![相談アイデア](docs/screenshots/ideas.png) |
...
163 件のテストが、痛み検知・走行指示の検査・目標からのペースとVDOTの導出・心拍ゾーンの計算・
